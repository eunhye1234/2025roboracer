...
def load_parameter_file(planner_name):
    ...
    file_name = os.path.join(config_dir, f'{planner_name}.yaml')

    # file_name = f"/home/autodrive_devkit/src/autodrive_devkit/autodrive_roboracer/TinyLidarNet/{planner_name}.yaml"
